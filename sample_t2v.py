...
def parse_args(input_args=None):
    ...
    parser.add_argument("--prompt", type=str, default="a few cartoon characters are having a conversation",
                         help="Text prompt to condition video generation on.")
    parser.add_argument("--num_samples", type=int, default=3, help="Number of videos to sample for the prompt.")
    parser.add_argument("--out_dir", type=str, default=".", help="Directory to write output .mp4 files to.")
